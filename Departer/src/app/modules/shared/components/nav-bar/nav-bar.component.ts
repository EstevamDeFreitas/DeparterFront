...
export class NavBarComponent implements OnInit {
  ...
  irParaConfiguracaoUsuarios() {
    // LÛgica para ir para a tela de usu·rios
  }
  ...
  alternarModoAdmin() {
    ...
    if(this.modoAdmin) {
      this.snackbarComponent.openSnackBar("Modo Administrador est√° ativado !",SnackBarTheme.success,3000);
    }
    else {
      this.snackbarComponent.openSnackBar("Modo Administrador est√° desativado !",SnackBarTheme.success,3000);
